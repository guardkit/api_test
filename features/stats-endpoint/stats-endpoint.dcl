...
// @task:TASK-STAT-001
//
// PROVENANCE: promoted verbatim (content-identical) from the DCL spike artifact
// qa/dcl-spike/capability.dcl (frozen historical record — NEVER edited). This is
// the same capability spec, moved to its durable home on the `dcl` spec track at
// features/<slug>/<slug>.dcl and carrying the `@task:` marker discovery scans for.
//
